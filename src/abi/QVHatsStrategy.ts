import type { ContractAbi } from "@/app/types";

export const QVHatsStrategy: ContractAbi = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "voiceCreditsToAllocate",
        type: "uint256",
      },
    ],
    name: "AllocatedWithHat",
    type: "event",
  },
  {
    anonymous: false,
